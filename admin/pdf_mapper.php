...
$camposHogar = [
    ...
    ['key' => 'cb_estado_optimo', 'label' => '☑ Estado Óptimo', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'payload'],
    ['key' => 'cb_estado_muy_bueno', 'label' => '☑ Estado Muy Bueno', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'payload'],
    ['key' => 'cb_estado_bueno', 'label' => '☑ Estado Bueno', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'payload'],
    ['key' => 'cb_estado_regular', 'label' => '☑ Estado Regular', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'payload'],
    ['key' => 'cb_estado_malo', 'label' => '☑ Estado Malo', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'payload'],
    ['key' => 'cb_estado_muy_malo', 'label' => '☑ Estado Muy Malo', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'payload'],
    ['key' => 'cb_modif_sobrepeso_si', 'label' => '☑ Modificaciones Sobrepeso Sí', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'payload'],
    ['key' => 'cb_modif_sobrepeso_no', 'label' => '☑ Modificaciones Sobrepeso No', 'type' => 'checkbox', 'section' => 'P2: Estado', 'source' => 'fijo'],

    // === INTERÉS ASEGURABLE ===
    ['key' => 'cb_interes_propietario', 'label' => '☑ Propietario', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'fijo'],
    ['key' => 'cb_interes_arrendatario', 'label' => '☑ Arrendatario', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_interes_usufructuario', 'label' => '☑ Usufructuario', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_interes_depositario', 'label' => '☑ Depositario', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_interes_acreedor', 'label' => '☑ Acreedor', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_interes_consignatario', 'label' => '☑ Consignatario', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_interes_otro', 'label' => '☑ Otro Interés', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'interes_otro_texto', 'label' => 'Especificar Otro Interés', 'type' => 'text', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'actividad_inmueble', 'label' => 'Actividad en Inmueble', 'type' => 'text', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'pct_casa_habitacion', 'label' => '% Casa Habitación', 'type' => 'text', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'pct_otras_ocupaciones', 'label' => '% Otras Ocupaciones', 'type' => 'text', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'detalle_actividad', 'label' => 'Detalle Actividad', 'type' => 'text', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_ocupado_propietario', 'label' => '☑ Ocupado por Propietario', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'fijo'],
    ['key' => 'cb_ocupado_inquilino', 'label' => '☑ Ocupado por Inquilino', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'nombre_propietario', 'label' => 'Nombre Propietario Inmueble', 'type' => 'text', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_gas_si', 'label' => '☑ Usa Gas LP Sí', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],
    ['key' => 'cb_gas_no', 'label' => '☑ Usa Gas LP No', 'type' => 'checkbox', 'section' => 'P2: Interés Asegurable', 'source' => 'fijo'],
    ['key' => 'sustancias_inflamables', 'label' => 'Sustancias Inflamables (tipo/cantidad)', 'type' => 'text', 'section' => 'P2: Interés Asegurable', 'source' => 'payload'],

    // === CERCANÍA A CUERPOS DE AGUA ===
    ['key' => 'cb_cerca_rio', 'label' => '☑ Cerca de Río', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_cerca_pleamar', 'label' => '☑ Cerca Línea Pleamar', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_cerca_lago', 'label' => '☑ Cerca de Lago', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_cerca_talud', 'label' => '☑ Cerca de Talud', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_cerca_pendiente', 'label' => '☑ Cerca de Pendiente', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_cerca_otro_agua', 'label' => '☑ Otro Cuerpo de Agua', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_cerca_ninguna', 'label' => '☑ Ninguna de las Anteriores', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'fijo'],
    ['key' => 'cb_dist_0_5m', 'label' => '☑ Distancia 0-5m', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_dist_6_10m', 'label' => '☑ Distancia 6-10m', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_dist_11_20m', 'label' => '☑ Distancia 11-20m', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_dist_21_49m', 'label' => '☑ Distancia 21-49m', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_dist_50_100m', 'label' => '☑ Distancia 50-100m', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],
    ['key' => 'cb_dist_mas_100m', 'label' => '☑ Distancia +100m', 'type' => 'checkbox', 'section' => 'P2: Cercanía Agua', 'source' => 'payload'],

    // === COLINDANTES ===
    ['key' => 'colindante_norte', 'label' => 'Colindante Norte', 'type' => 'text', 'section' => 'P2: Colindantes', 'source' => 'payload'],
    ['key' => 'colindante_sur', 'label' => 'Colindante Sur', 'type' => 'text', 'section' => 'P2: Colindantes', 'source' => 'payload'],
    ['key' => 'colindante_este', 'label' => 'Colindante Este', 'type' => 'text', 'section' => 'P2: Colindantes', 'source' => 'payload'],
    ['key' => 'colindante_oeste', 'label' => 'Colindante Oeste', 'type' => 'text', 'section' => 'P2: Colindantes', 'source' => 'payload'],

    // === TIPO DE CONSTRUCCIÓN (E1-E14) ===
    ['key' => 'cb_const_e1', 'label' => '☑ E1 Mampostería Ladrillo', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e2', 'label' => '☑ E2 Mampostería Block', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e3', 'label' => '☑ E3 Concreto Reforzado', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e4', 'label' => '☑ E4 Concreto Prefabricado', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e5', 'label' => '☑ E5 Panelería Doble Forro', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e6', 'label' => '☑ E6 Panelería Emparedado', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e7', 'label' => '☑ E7 Madera', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e8', 'label' => '☑ E8 Mixto Madera-Concreto', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'fijo'],
    ['key' => 'cb_const_e9', 'label' => '☑ E9 Marcos Concreto Muros Corte', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e10', 'label' => '☑ E10 Marcos de Acero', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e11', 'label' => '☑ E11 Estructuras Sobrepuestas', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e12', 'label' => '☑ E12 Naves Mampostería', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e13', 'label' => '☑ E13 Naves de Acero', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],
    ['key' => 'cb_const_e14', 'label' => '☑ E14 Naves Concreto Prefab.', 'type' => 'checkbox', 'section' => 'P2: Tipo Construcción', 'source' => 'payload'],

    // === MEDIDAS SEGURIDAD COB. Y (Robo) ===
    ['key' => 'cb_vigilancia_interna', 'label' => '☑ Vigilancia Interna', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_vigilancia_externa', 'label' => '☑ Vigilancia Externa', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_horario_diurno', 'label' => '☑ Horario Diurno', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_horario_nocturno', 'label' => '☑ Horario Nocturno', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_propiedad_sola_si', 'label' => '☑ Propiedad Sola Sí', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_propiedad_sola_no', 'label' => '☑ Propiedad Sola No', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'fijo'],
    ['key' => 'propiedad_sola_horas', 'label' => 'Cantidad Horas Sola', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_alarma_no_tiene', 'label' => '☑ Alarma: No Tiene', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_alarma_magnetica', 'label' => '☑ Alarma Magnética', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_alarma_electronica', 'label' => '☑ Alarma Electrónica', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_alarma_central', 'label' => '☑ Conectada Central Seguridad', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_cctv_jardines', 'label' => '☑ CCTV en Jardines', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_luces_infrarrojas', 'label' => '☑ Luces Infrarrojas/Láser', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_llavin_sencillo', 'label' => '☑ Llavín Sencillo', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_llavin_doble_paso', 'label' => '☑ Llavín Doble Paso', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'fijo'],
    ['key' => 'cerradura_otro', 'label' => 'Cerradura Otro Tipo', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_tapias_si', 'label' => '☑ Tiene Tapias Sí', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_tapias_no', 'label' => '☑ Tiene Tapias No', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'tapias_altura', 'label' => 'Altura Tapias', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'tapias_material', 'label' => 'Material Tapias', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_alambre_navaja', 'label' => '☑ Con Alambre Navaja', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_frente_muros', 'label' => '☑ Frente: Muros', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_frente_verjas', 'label' => '☑ Frente: Verjas', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'frente_otro', 'label' => 'Frente: Otro', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_ventana_frances', 'label' => '☑ Ventana Tipo Francés', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_ventana_corriente', 'label' => '☑ Ventana Corriente', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_ventana_celosias', 'label' => '☑ Ventana Con Celosías', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_ventana_verjas', 'label' => '☑ Ventana Verjas', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'fijo'],
    ['key' => 'cb_ventana_cortinas_metal', 'label' => '☑ Cortinas Metálicas', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_ventana_vidrio_seg', 'label' => '☑ Vidrio de Seguridad', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'ventana_otro', 'label' => 'Ventana: Otro', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_puerta_madera', 'label' => '☑ Puerta Madera', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_puerta_vidrio', 'label' => '☑ Puerta Vidrio', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_puerta_verjas', 'label' => '☑ Verjas o Anteportón', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_puerta_contrapuerta', 'label' => '☑ Contrapuerta', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'cb_puerta_marco_seg', 'label' => '☑ Marco de Seguridad', 'type' => 'checkbox', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'puerta_otro', 'label' => 'Puerta: Otro', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],
    ['key' => 'otra_medida_seguridad', 'label' => 'Otra Medida de Seguridad', 'type' => 'text', 'section' => 'P2: Seguridad Cob Y', 'source' => 'payload'],

    // ==================== PÁGINA 3 ====================
    // === MEDIDAS SEGURIDAD INCENDIO ===
    ['key' => 'cb_proteccion_auto', 'label' => '☑ Protección Incendio Automático', 'type' => 'checkbox', 'section' => 'P3: Seguridad Incendio', 'source' => 'payload'],
    ['key' => 'cb_proteccion_manual', 'label' => '☑ Protección Incendio Manual', 'type' => 'checkbox', 'section' => 'P3: Seguridad Incendio', 'source' => 'payload'],
    ['key' => 'cb_codigo_electrico', 'label' => '☑ Implementación Código Eléctrico', 'type' => 'checkbox', 'section' => 'P3: Seguridad Incendio', 'source' => 'payload'],
    ['key' => 'cb_detectores_humo', 'label' => '☑ Detectores Humo/Llama/Térmicos', 'type' => 'checkbox', 'section' => 'P3: Seguridad Incendio', 'source' => 'payload'],
    ['key' => 'cb_alarma_sonora', 'label' => '☑ Alarma Sonora y/o Visual', 'type' => 'checkbox', 'section' => 'P3: Seguridad Incendio', 'source' => 'payload'],

    // === PRÁCTICAS SOSTENIBLES ===
    ['key' => 'cb_led_70', 'label' => '☑ LED >70% Residencia', 'type' => 'checkbox', 'section' => 'P3: Sostenibilidad', 'source' => 'fijo'],
    ['key' => 'cb_paneles_solares', 'label' => '☑ Paneles Solares', 'type' => 'checkbox', 'section' => 'P3: Sostenibilidad', 'source' => 'payload'],

    // === ACCIDENTES PERSONALES ===
    ['key' => 'ap_asegurado_nombre', 'label' => 'AP Asegurado: Nombre', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_asegurado_cedula', 'label' => 'AP Asegurado: Cédula', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_asegurado_fecha_nac', 'label' => 'AP Asegurado: Fecha Nac.', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_asegurado_edad', 'label' => 'AP Asegurado: Edad', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'cb_ap_asegurado_zurdo_si', 'label' => '☑ AP Asegurado Zurdo Sí', 'type' => 'checkbox', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'cb_ap_asegurado_zurdo_no', 'label' => '☑ AP Asegurado Zurdo No', 'type' => 'checkbox', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_asegurado_muerte', 'label' => 'AP Asegurado: Muerte Accidental', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_asegurado_incapacidad', 'label' => 'AP Asegurado: Incapacidad', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_asegurado_gastos_med', 'label' => 'AP Asegurado: Gastos Médicos', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_conyuge_nombre', 'label' => 'AP Cónyuge: Nombre', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_conyuge_cedula', 'label' => 'AP Cónyuge: Cédula', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_conyuge_fecha_nac', 'label' => 'AP Cónyuge: Fecha Nac.', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_hijo1_nombre', 'label' => 'AP Hijo 1: Nombre', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_hijo1_cedula', 'label' => 'AP Hijo 1: Cédula', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_hijo2_nombre', 'label' => 'AP Hijo 2: Nombre', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_hijo2_cedula', 'label' => 'AP Hijo 2: Cédula', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_indemnizacion_nombre', 'label' => 'Recibe Indemnización: Nombre', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_defecto_nombre', 'label' => 'Defecto Físico: Nombre', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_defecto_parte', 'label' => 'Defecto: Parte Afectada', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_defecto_causa', 'label' => 'Defecto: Causa', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_defecto_fecha', 'label' => 'Defecto: Fecha Suceso', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],
    ['key' => 'ap_defecto_grado', 'label' => 'Defecto: Grado Pérdida', 'type' => 'text', 'section' => 'P3: Accidentes Personales', 'source' => 'payload'],

    // === COBERTURA RIESGOS DEL TRABAJO HOGAR ===
    ['key' => 'cb_rt_opcion1', 'label' => '☑ RT Opción 1: Un Trabajador', 'type' => 'checkbox', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'cb_rt_opcion2', 'label' => '☑ RT Opción 2: Dos Trabajadores', 'type' => 'checkbox', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'cb_rt_opcion3', 'label' => '☑ RT Opción 3: Tres o Más', 'type' => 'checkbox', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'rt_trab1_nombre', 'label' => 'RT Trabajador 1: Nombre', 'type' => 'text', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'rt_trab1_cedula', 'label' => 'RT Trabajador 1: Cédula', 'type' => 'text', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'rt_trab1_ocupacion', 'label' => 'RT Trabajador 1: Ocupación', 'type' => 'text', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'rt_trab2_nombre', 'label' => 'RT Trabajador 2: Nombre', 'type' => 'text', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'rt_trab2_cedula', 'label' => 'RT Trabajador 2: Cédula', 'type' => 'text', 'section' => 'P3: RT Hogar', 'source' => 'payload'],
    ['key' => 'rt_trab2_ocupacion', 'label' => 'RT Trabajador 2: Ocupación', 'type' => 'text', 'section' => 'P3: RT Hogar', 'source' => 'payload'],

    // === RESPONSABILIDAD CIVIL ===
    ['key' => 'cb_gradas_antideslizante', 'label' => '☑ Gradas: Piso Antideslizante', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_gradas_alfombras', 'label' => '☑ Gradas: Cubiertas Alfombras', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_gradas_cintas', 'label' => '☑ Gradas: Cintas Antideslizantes', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_gradas_pasamanos_esc', 'label' => '☑ Pasamanos en Escaleras', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_gradas_pasamanos_desn', 'label' => '☑ Pasamanos en Desniveles', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_piscina_antideslizante', 'label' => '☑ Piscina: Pisos Antideslizantes', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_piscina_banos', 'label' => '☑ Piscina: Baños/Áreas Acceso', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_piscina_areas_exp', 'label' => '☑ Piscina: Áreas Expuestas', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_piscina_salvavidas', 'label' => '☑ Piscina: Salvavidas', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_piscina_flotadores', 'label' => '☑ Piscina: Flotadores', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'piscina_otras_medidas', 'label' => 'Piscina: Otras Medidas', 'type' => 'text', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_animales_si', 'label' => '☑ Posee Animales Sí', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_animales_no', 'label' => '☑ Posee Animales No', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'fijo'],
    ['key' => 'cb_animales_dentro_si', 'label' => '☑ Animales Dentro Predios Sí', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_animales_dentro_no', 'label' => '☑ Animales Dentro Predios No', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_animales_avisos_si', 'label' => '☑ Avisos Animales Sí', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_animales_avisos_no', 'label' => '☑ Avisos Animales No', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_animales_seguridad_si', 'label' => '☑ Animales Área Seguridad Sí', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],
    ['key' => 'cb_animales_seguridad_no', 'label' => '☑ Animales Área Seguridad No', 'type' => 'checkbox', 'section' => 'P3: Resp. Civil', 'source' => 'payload'],

    // ==================== PÁGINA 4 ====================
    // === DESIGNACIÓN DE BENEFICIARIO ===
    ['key' => 'cb_benef_pj_nacional', 'label' => '☑ Benef. PJ Nacional', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pj_extranjera', 'label' => '☑ Benef. PJ Extranjera', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pj_gobierno', 'label' => '☑ Benef. Gobierno', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pj_autonoma', 'label' => '☑ Benef. Inst. Autónoma', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pf_cedula', 'label' => '☑ Benef. Cédula', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pf_dimex', 'label' => '☑ Benef. DIMEX', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pf_didi', 'label' => '☑ Benef. DIDI', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pf_pasaporte', 'label' => '☑ Benef. Pasaporte', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'cb_benef_pf_otro', 'label' => '☑ Benef. Otro ID', 'type' => 'checkbox', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'benef_num_id', 'label' => 'Beneficiario: N° ID', 'type' => 'text', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'benef_nombre', 'label' => 'Beneficiario: Nombre', 'type' => 'text', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'benef_parentesco', 'label' => 'Beneficiario: Parentesco', 'type' => 'text', 'section' => 'P4: Beneficiario', 'source' => 'payload'],
    ['key' => 'benef_porcentaje', 'label' => 'Beneficiario: Porcentaje', 'type' => 'text', 'section' => 'P4: Beneficiario', 'source' => 'payload'],

    // === DATOS DEL ACREEDOR ===
    ['key' => 'cb_acreedor_pj_nacional', 'label' => '☑ Acreedor PJ Nacional', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pj_extranjera', 'label' => '☑ Acreedor PJ Extranjera', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pj_gobierno', 'label' => '☑ Acreedor Gobierno', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pj_autonoma', 'label' => '☑ Acreedor Inst. Autónoma', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pf_cedula', 'label' => '☑ Acreedor Cédula', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pf_dimex', 'label' => '☑ Acreedor DIMEX', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pf_didi', 'label' => '☑ Acreedor DIDI', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pf_pasaporte', 'label' => '☑ Acreedor Pasaporte', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'cb_acreedor_pf_otro', 'label' => '☑ Acreedor Otro ID', 'type' => 'checkbox', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'acreedor_num_id', 'label' => 'Acreedor: N° ID', 'type' => 'text', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'acreedor_nombre', 'label' => 'Acreedor: Nombre/Razón Social', 'type' => 'text', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'acreedor_monto', 'label' => 'Acreedor: Monto Acreencia', 'type' => 'text', 'section' => 'P4: Acreedor', 'source' => 'payload'],
    ['key' => 'acreedor_grado', 'label' => 'Acreedor: Grado Acreencia', 'type' => 'text', 'section' => 'P4: Acreedor', 'source' => 'payload'],

    // === DATOS DE LA PÓLIZA ===
    ['key' => 'vigencia_desde', 'label' => 'Vigencia Desde', 'type' => 'text', 'section' => 'P4: Datos Póliza', 'source' => 'sistema'],
    ['key' => 'vigencia_hasta', 'label' => 'Vigencia Hasta', 'type' => 'text', 'section' => 'P4: Datos Póliza', 'source' => 'sistema'],
    ['key' => 'cb_moneda_colones', 'label' => '☑ Moneda Colones', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'fijo'],
    ['key' => 'cb_moneda_dolares', 'label' => '☑ Moneda Dólares', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_pago_anual', 'label' => '☑ Pago Anual', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_pago_cuatrimestral', 'label' => '☑ Pago Cuatrimestral', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_pago_bimestral', 'label' => '☑ Pago Bimestral', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_pago_semestral', 'label' => '☑ Pago Semestral', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'fijo'],
    ['key' => 'cb_pago_trimestral', 'label' => '☑ Pago Trimestral', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_pago_mensual', 'label' => '☑ Pago Mensual', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_poliza_otra_si', 'label' => '☑ Póliza Otra Aseg. Sí', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_poliza_otra_no', 'label' => '☑ Póliza Otra Aseg. No', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'fijo'],
    ['key' => 'otra_aseguradora_nombre', 'label' => 'Otra Aseguradora: Nombre', 'type' => 'text', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'otra_aseguradora_poliza', 'label' => 'Otra Aseguradora: N° Póliza', 'type' => 'text', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_aseg_cuenta_tercero', 'label' => '☑ Por Cuenta de Tercero', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_aseg_cuenta_propia', 'label' => '☑ Por Cuenta Propia', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'fijo'],
    ['key' => 'cb_via_cargo_auto', 'label' => '☑ Vía: Cargo Automático', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],
    ['key' => 'cb_via_deduccion', 'label' => '☑ Vía: Deducción Mensual', 'type' => 'checkbox', 'section' => 'P4: Datos Póliza', 'source' => 'payload'],

    // === RUBROS ASEGURADOS ===
    ['key' => 'rubro_residencia_expuesto', 'label' => 'Residencia: Monto Expuesto', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_residencia_asegurado', 'label' => 'Residencia: Monto Asegurado', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_residencia_prima', 'label' => 'Residencia: Prima', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'ins'],
    ['key' => 'rubro_prop_personal_expuesto', 'label' => 'Prop. Personal: Monto Expuesto', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_prop_personal_asegurado', 'label' => 'Prop. Personal: Monto Asegurado', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_prop_personal_prima', 'label' => 'Prop. Personal: Prima', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'ins'],
    ['key' => 'rubro_joyeria_expuesto', 'label' => 'Joyería: Monto Expuesto', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_joyeria_asegurado', 'label' => 'Joyería: Monto Asegurado', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_joyeria_prima', 'label' => 'Joyería: Prima', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'ins'],
    ['key' => 'rubro_arte_expuesto', 'label' => 'Obras Arte: Monto Expuesto', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_arte_asegurado', 'label' => 'Obras Arte: Monto Asegurado', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_arte_prima', 'label' => 'Obras Arte: Prima', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'ins'],
    ['key' => 'rubro_rentas_asegurado', 'label' => 'Pérdida Rentas: Monto Asegurado', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_rentas_prima', 'label' => 'Pérdida Rentas: Prima', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'ins'],
    ['key' => 'rubro_rc_asegurado', 'label' => 'Resp. Civil: Monto Asegurado', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'payload'],
    ['key' => 'rubro_rc_prima', 'label' => 'Resp. Civil: Prima', 'type' => 'text', 'section' => 'P4: Rubros', 'source' => 'ins'],
    ['key' => 'cb_opcion_100', 'label' => '☑ Opción 100%', 'type' => 'checkbox', 'section' => 'P4: Rubros', 'source' => 'fijo'],
    ['key' => 'cb_opcion_coaseguro_80', 'label' => '☑ Coaseguro 80%', 'type' => 'checkbox', 'section' => 'P4: Rubros', 'source' => 'payload'],

    // === OBRAS COMPLEMENTARIAS ===
    ['key' => 'obra_bodegas_monto', 'label' => 'Bodegas: Monto', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_bodegas_area', 'label' => 'Bodegas: Área m²', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_piscinas_monto', 'label' => 'Piscinas: Monto', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_piscinas_area', 'label' => 'Piscinas: Área m²', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_tapias_monto', 'label' => 'Tapias: Monto', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_tapias_area', 'label' => 'Tapias: Área m²', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_garajes_monto', 'label' => 'Garajes: Monto', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_garajes_area', 'label' => 'Garajes: Área m²', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],
    ['key' => 'obra_otros', 'label' => 'Otros (especifique)', 'type' => 'text', 'section' => 'P4: Obras Compl.', 'source' => 'payload'],

    // === PRIMA TOTAL ===
    ['key' => 'prima_subtotal', 'label' => 'Prima', 'type' => 'text', 'section' => 'P4: Prima', 'source' => 'ins'],
    ['key' => 'prima_recargo', 'label' => 'Recargo Fraccionamiento', 'type' => 'text', 'section' => 'P4: Prima', 'source' => 'ins'],
    ['key' => 'prima_iva', 'label' => 'IVA', 'type' => 'text', 'section' => 'P4: Prima', 'source' => 'ins'],
    ['key' => 'prima_total', 'label' => 'Prima Total', 'type' => 'text', 'section' => 'P4: Prima', 'source' => 'ins'],
    ['key' => 'cb_valor_reposicion', 'label' => '☑ Condición: Valor Reposición', 'type' => 'checkbox', 'section' => 'P4: Prima', 'source' => 'fijo'],
    ['key' => 'cb_valor_real', 'label' => '☑ Condición: Valor Real Efectivo', 'type' => 'checkbox', 'section' => 'P4: Prima', 'source' => 'payload'],
    ['key' => 'cb_valor_otro', 'label' => '☑ Condición: Otro', 'type' => 'checkbox', 'section' => 'P4: Prima', 'source' => 'payload'],
    ['key' => 'valor_otro_texto', 'label' => 'Condición Otro: Especificar', 'type' => 'text', 'section' => 'P4: Prima', 'source' => 'payload'],

    // ==================== PÁGINA 5 ====================
    // === COBERTURAS BÁSICAS ===
    ['key' => 'cb_cob_v', 'label' => '☑ V: Daño Directo Bienes Inmuebles', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'fijo'],
    ['key' => 'cb_cob_y', 'label' => '☑ Y: Daño Directo Contenidos (robo)', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_y_con_lista', 'label' => '☑ Y: Con Lista', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_y_sin_lista', 'label' => '☑ Y: Sin Lista', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_y_grupo_1a', 'label' => '☑ Y: Grupo 1A', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_y_grupo_1b', 'label' => '☑ Y: Grupo 1B', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_y_grupo_2', 'label' => '☑ Y: Grupo 2', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_y_grupo_3', 'label' => '☑ Y: Grupo 3', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_x', 'label' => '☑ X: Daño Directo Contenidos (sin robo)', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_x_con_lista', 'label' => '☑ X: Con Lista', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],
    ['key' => 'cb_cob_x_sin_lista', 'label' => '☑ X: Sin Lista', 'type' => 'checkbox', 'section' => 'P5: Cob. Básicas', 'source' => 'payload'],

    // === COBERTURAS ADICIONALES ===
    ['key' => 'cb_cob_d', 'label' => '☑ D: Convulsiones Naturaleza', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'fijo'],
    ['key' => 'cb_cob_d_particip_0', 'label' => '☑ D: Participación 0%', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_d_particip_10', 'label' => '☑ D: Participación 10%', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_d_particip_20', 'label' => '☑ D: Participación 20%', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_h', 'label' => '☑ H: Pérdida Rentas Arrendamiento', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_h_3meses', 'label' => '☑ H: Período 3 meses', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_h_4_6meses', 'label' => '☑ H: Período 4-6 meses', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_h_7_12meses', 'label' => '☑ H: Período 7-12 meses', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_k', 'label' => '☑ K: Responsabilidad Civil', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_m', 'label' => '☑ M: Riesgos del Trabajo Hogar', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_p', 'label' => '☑ P: Accidentes Personales', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cb_cob_t', 'label' => '☑ T: Multiasistencia Hogar (gratuita)', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'fijo'],
    ['key' => 'cb_cob_s', 'label' => '☑ S: Multiasistencia Extendida', 'type' => 'checkbox', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],
    ['key' => 'cob_s_beneficiario', 'label' => 'S: Nombre Beneficiario PJ', 'type' => 'text', 'section' => 'P5: Cob. Adicionales', 'source' => 'payload'],

    // === PROTECCIÓN CONTRA INFLACIÓN ===
    ['key' => 'cb_pci_no_aplicar', 'label' => '☑ PCI: No Aplicar', 'type' => 'checkbox', 'section' => 'P5: Protección Inflación', 'source' => 'fijo'],

    // === DEDUCIBLES V (Bienes Inmuebles) ===
    ['key' => 'cb_ded_v_incendio_sin', 'label' => '☑ V Incendio: Sin Deducible', 'type' => 'checkbox', 'section' => 'P5: Deducibles V', 'source' => 'fijo'],
    ['key' => 'cb_ded_v_vientos_1pct', 'label' => '☑ V Vientos/Inund: 1% monto', 'type' => 'checkbox', 'section' => 'P5: Deducibles V', 'source' => 'fijo'],
    ['key' => 'ded_v_vientos_otro', 'label' => 'V Vientos/Inund: Otro', 'type' => 'text', 'section' => 'P5: Deducibles V', 'source' => 'payload'],
    ['key' => 'cb_ded_v_riesgos_fijo', 'label' => '☑ V Riesgos Varios: ¢62.500/$100', 'type' => 'checkbox', 'section' => 'P5: Deducibles V', 'source' => 'fijo'],
    ['key' => 'ded_v_riesgos_otro', 'label' => 'V Riesgos Varios: Otro', 'type' => 'text', 'section' => 'P5: Deducibles V', 'source' => 'payload'],

    // === DEDUCIBLES X/Y (Contenidos) ===
    ['key' => 'cb_ded_xy_incendio_sin', 'label' => '☑ X/Y Incendio: Sin Deducible', 'type' => 'checkbox', 'section' => 'P5: Deducibles X/Y', 'source' => 'fijo'],
    ['key' => 'cb_ded_xy_vientos_1pct', 'label' => '☑ X/Y Vientos: 1% monto', 'type' => 'checkbox', 'section' => 'P5: Deducibles X/Y', 'source' => 'fijo'],
    ['key' => 'ded_xy_vientos_otro', 'label' => 'X/Y Vientos: Otro', 'type' => 'text', 'section' => 'P5: Deducibles X/Y', 'source' => 'payload'],
    ['key' => 'cb_ded_y_robo_10pct', 'label' => '☑ Y Robo: 10% pérdida', 'type' => 'checkbox', 'section' => 'P5: Deducibles X/Y', 'source' => 'fijo'],
    ['key' => 'ded_y_robo_otro', 'label' => 'Y Robo: Otro', 'type' => 'text', 'section' => 'P5: Deducibles X/Y', 'source' => 'payload'],
    ['key' => 'cb_ded_xy_riesgos_fijo', 'label' => '☑ X/Y Riesgos: ¢62.500/$100', 'type' => 'checkbox', 'section' => 'P5: Deducibles X/Y', 'source' => 'fijo'],
    ['key' => 'ded_xy_riesgos_otro', 'label' => 'X/Y Riesgos: Otro', 'type' => 'text', 'section' => 'P5: Deducibles X/Y', 'source' => 'payload'],

    // === DEDUCIBLES D (Convulsiones) ===
    ['key' => 'cb_ded_d_1pct', 'label' => '☑ D: 1% monto afectado', 'type' => 'checkbox', 'section' => 'P5: Deducibles D', 'source' => 'fijo'],
    ['key' => 'ded_d_otro', 'label' => 'D: Otro', 'type' => 'text', 'section' => 'P5: Deducibles D', 'source' => 'payload'],

    // === DEDUCIBLES OTROS ===
    ['key' => 'cb_ded_h_3dias', 'label' => '☑ H: Mínimo 3 días', 'type' => 'checkbox', 'section' => 'P5: Deducibles Otros', 'source' => 'fijo'],
    ['key' => 'ded_h_otro', 'label' => 'H: Otro', 'type' => 'text', 'section' => 'P5: Deducibles Otros', 'source' => 'payload'],
    ['key' => 'cb_ded_k_sin', 'label' => '☑ K: Sin Deducible', 'type' => 'checkbox', 'section' => 'P5: Deducibles Otros', 'source' => 'fijo'],
    ['key' => 'cb_ded_m_sin', 'label' => '☑ M: Sin Deducible', 'type' => 'checkbox', 'section' => 'P5: Deducibles Otros', 'source' => 'fijo'],
    ['key' => 'cb_ded_p_10pct', 'label' => '☑ P: 10% gastos mín ¢20.000/$40', 'type' => 'checkbox', 'section' => 'P5: Deducibles Otros', 'source' => 'fijo'],
    ['key' => 'ded_p_otro', 'label' => 'P: Otro', 'type' => 'text', 'section' => 'P5: Deducibles Otros', 'source' => 'payload'],

    // ==================== PÁGINA 6 ====================
    // === FIRMAS ===
    ['key' => 'firma_tomador_nombre', 'label' => 'Firma Tomador: Nombre', 'type' => 'text', 'section' => 'P6: Firmas', 'source' => 'payload'],
    ['key' => 'firma_tomador_id', 'label' => 'Firma Tomador: N° ID', 'type' => 'text', 'section' => 'P6: Firmas', 'source' => 'payload'],
    ['key' => 'intermediario_nombre', 'label' => 'Intermediario: Nombre', 'type' => 'text', 'section' => 'P6: Firmas', 'source' => 'fijo'],
    ['key' => 'intermediario_numero', 'label' => 'Intermediario: Número', 'type' => 'text', 'section' => 'P6: Firmas', 'source' => 'fijo'],
    ['key' => 'sociedad_agencia', 'label' => 'Sociedad Agencia/Corredora', 'type' => 'text', 'section' => 'P6: Firmas', 'source' => 'fijo'],
    ['key' => 'riesgo_aceptado_por', 'label' => 'Riesgo Aceptado Por', 'type' => 'text', 'section' => 'P6: Firmas', 'source' => 'ins'],
    ['key' => 'revisado_por', 'label' => 'Revisado Por', 'type' => 'text', 'section' => 'P6: Firmas', 'source' => 'ins'],
];
...
$camposRT = [
    ...
    ['key' => 'planilla_poliza_numero', 'label' => 'Planilla Póliza N°', 'type' => 'text', 'section' => 'P3 Encabezado', 'source' => 'ins'],

    // === TRABAJADOR 1 ===
    ['key' => 'trab1_tipo_id', 'label' => 'Trab 1 - Tipo ID (CN/DU/NP/NT)', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_nacionalidad', 'label' => 'Trab 1 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_num_id', 'label' => 'Trab 1 - N° Identificación', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_nombre', 'label' => 'Trab 1 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_apellido1', 'label' => 'Trab 1 - Primer Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_apellido2', 'label' => 'Trab 1 - Segundo Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_fecha_nacimiento', 'label' => 'Trab 1 - F. Nacimiento', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_sexo', 'label' => 'Trab 1 - Sexo (M/F)', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_tipo_jornada', 'label' => 'Trab 1 - Tipo Jornada (TC/TM/OD/OH)', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_salario_mensual', 'label' => 'Trab 1 - Salario Mensual', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_dias', 'label' => 'Trab 1 - Días', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_horas', 'label' => 'Trab 1 - Horas', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],
    ['key' => 'trab1_ocupacion', 'label' => 'Trab 1 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajador 1', 'source' => 'payload'],

    // === TRABAJADOR 2 ===
    ['key' => 'trab2_tipo_id', 'label' => 'Trab 2 - Tipo ID (CN/DU/NP/NT)', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_nacionalidad', 'label' => 'Trab 2 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_num_id', 'label' => 'Trab 2 - N° Identificación', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_nombre', 'label' => 'Trab 2 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_apellido1', 'label' => 'Trab 2 - Primer Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_apellido2', 'label' => 'Trab 2 - Segundo Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_fecha_nacimiento', 'label' => 'Trab 2 - F. Nacimiento', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_sexo', 'label' => 'Trab 2 - Sexo (M/F)', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_tipo_jornada', 'label' => 'Trab 2 - Tipo Jornada (TC/TM/OD/OH)', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_salario_mensual', 'label' => 'Trab 2 - Salario Mensual', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_dias', 'label' => 'Trab 2 - Días', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_horas', 'label' => 'Trab 2 - Horas', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],
    ['key' => 'trab2_ocupacion', 'label' => 'Trab 2 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajador 2', 'source' => 'payload'],

    // === TRABAJADOR 3 ===
    ['key' => 'trab3_tipo_id', 'label' => 'Trab 3 - Tipo ID (CN/DU/NP/NT)', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_nacionalidad', 'label' => 'Trab 3 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_num_id', 'label' => 'Trab 3 - N° Identificación', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_nombre', 'label' => 'Trab 3 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_apellido1', 'label' => 'Trab 3 - Primer Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_apellido2', 'label' => 'Trab 3 - Segundo Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_fecha_nacimiento', 'label' => 'Trab 3 - F. Nacimiento', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_sexo', 'label' => 'Trab 3 - Sexo (M/F)', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_tipo_jornada', 'label' => 'Trab 3 - Tipo Jornada (TC/TM/OD/OH)', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_salario_mensual', 'label' => 'Trab 3 - Salario Mensual', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_dias', 'label' => 'Trab 3 - Días', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_horas', 'label' => 'Trab 3 - Horas', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],
    ['key' => 'trab3_ocupacion', 'label' => 'Trab 3 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajador 3', 'source' => 'payload'],

    // === TRABAJADOR 4 ===
    ['key' => 'trab4_tipo_id', 'label' => 'Trab 4 - Tipo ID (CN/DU/NP/NT)', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_nacionalidad', 'label' => 'Trab 4 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_num_id', 'label' => 'Trab 4 - N° Identificación', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_nombre', 'label' => 'Trab 4 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_apellido1', 'label' => 'Trab 4 - Primer Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_apellido2', 'label' => 'Trab 4 - Segundo Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_fecha_nacimiento', 'label' => 'Trab 4 - F. Nacimiento', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_sexo', 'label' => 'Trab 4 - Sexo (M/F)', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_tipo_jornada', 'label' => 'Trab 4 - Tipo Jornada (TC/TM/OD/OH)', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_salario_mensual', 'label' => 'Trab 4 - Salario Mensual', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_dias', 'label' => 'Trab 4 - Días', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_horas', 'label' => 'Trab 4 - Horas', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],
    ['key' => 'trab4_ocupacion', 'label' => 'Trab 4 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajador 4', 'source' => 'payload'],

    // === TRABAJADOR 5 ===
    ['key' => 'trab5_tipo_id', 'label' => 'Trab 5 - Tipo ID (CN/DU/NP/NT)', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_nacionalidad', 'label' => 'Trab 5 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_num_id', 'label' => 'Trab 5 - N° Identificación', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_nombre', 'label' => 'Trab 5 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_apellido1', 'label' => 'Trab 5 - Primer Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_apellido2', 'label' => 'Trab 5 - Segundo Apellido', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_fecha_nacimiento', 'label' => 'Trab 5 - F. Nacimiento', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_sexo', 'label' => 'Trab 5 - Sexo (M/F)', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_tipo_jornada', 'label' => 'Trab 5 - Tipo Jornada (TC/TM/OD/OH)', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_salario_mensual', 'label' => 'Trab 5 - Salario Mensual', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_dias', 'label' => 'Trab 5 - Días', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_horas', 'label' => 'Trab 5 - Horas', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],
    ['key' => 'trab5_ocupacion', 'label' => 'Trab 5 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajador 5', 'source' => 'payload'],

    // === TRABAJADORES 6-10 (campos adicionales para más trabajadores) ===
    ['key' => 'trab6_tipo_id', 'label' => 'Trab 6 - Tipo ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_nacionalidad', 'label' => 'Trab 6 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_num_id', 'label' => 'Trab 6 - N° ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_nombre', 'label' => 'Trab 6 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_apellido1', 'label' => 'Trab 6 - Apellido 1', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_apellido2', 'label' => 'Trab 6 - Apellido 2', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_fecha_nacimiento', 'label' => 'Trab 6 - F. Nac', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_sexo', 'label' => 'Trab 6 - Sexo', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_tipo_jornada', 'label' => 'Trab 6 - T. Jornada', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_salario_mensual', 'label' => 'Trab 6 - Salario', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_dias', 'label' => 'Trab 6 - Días', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_horas', 'label' => 'Trab 6 - Horas', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab6_ocupacion', 'label' => 'Trab 6 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],

    ['key' => 'trab7_tipo_id', 'label' => 'Trab 7 - Tipo ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_nacionalidad', 'label' => 'Trab 7 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_num_id', 'label' => 'Trab 7 - N° ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_nombre', 'label' => 'Trab 7 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_apellido1', 'label' => 'Trab 7 - Apellido 1', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_apellido2', 'label' => 'Trab 7 - Apellido 2', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_fecha_nacimiento', 'label' => 'Trab 7 - F. Nac', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_sexo', 'label' => 'Trab 7 - Sexo', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_tipo_jornada', 'label' => 'Trab 7 - T. Jornada', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_salario_mensual', 'label' => 'Trab 7 - Salario', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_dias', 'label' => 'Trab 7 - Días', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_horas', 'label' => 'Trab 7 - Horas', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab7_ocupacion', 'label' => 'Trab 7 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],

    ['key' => 'trab8_tipo_id', 'label' => 'Trab 8 - Tipo ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_nacionalidad', 'label' => 'Trab 8 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_num_id', 'label' => 'Trab 8 - N° ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_nombre', 'label' => 'Trab 8 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_apellido1', 'label' => 'Trab 8 - Apellido 1', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_apellido2', 'label' => 'Trab 8 - Apellido 2', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_fecha_nacimiento', 'label' => 'Trab 8 - F. Nac', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_sexo', 'label' => 'Trab 8 - Sexo', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_tipo_jornada', 'label' => 'Trab 8 - T. Jornada', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_salario_mensual', 'label' => 'Trab 8 - Salario', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_dias', 'label' => 'Trab 8 - Días', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_horas', 'label' => 'Trab 8 - Horas', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab8_ocupacion', 'label' => 'Trab 8 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],

    ['key' => 'trab9_tipo_id', 'label' => 'Trab 9 - Tipo ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_nacionalidad', 'label' => 'Trab 9 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_num_id', 'label' => 'Trab 9 - N° ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_nombre', 'label' => 'Trab 9 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_apellido1', 'label' => 'Trab 9 - Apellido 1', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_apellido2', 'label' => 'Trab 9 - Apellido 2', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_fecha_nacimiento', 'label' => 'Trab 9 - F. Nac', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_sexo', 'label' => 'Trab 9 - Sexo', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_tipo_jornada', 'label' => 'Trab 9 - T. Jornada', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_salario_mensual', 'label' => 'Trab 9 - Salario', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_dias', 'label' => 'Trab 9 - Días', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_horas', 'label' => 'Trab 9 - Horas', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab9_ocupacion', 'label' => 'Trab 9 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],

    ['key' => 'trab10_tipo_id', 'label' => 'Trab 10 - Tipo ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_nacionalidad', 'label' => 'Trab 10 - Nacionalidad', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_num_id', 'label' => 'Trab 10 - N° ID', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_nombre', 'label' => 'Trab 10 - Nombre', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_apellido1', 'label' => 'Trab 10 - Apellido 1', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_apellido2', 'label' => 'Trab 10 - Apellido 2', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_fecha_nacimiento', 'label' => 'Trab 10 - F. Nac', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_sexo', 'label' => 'Trab 10 - Sexo', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_tipo_jornada', 'label' => 'Trab 10 - T. Jornada', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_salario_mensual', 'label' => 'Trab 10 - Salario', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_dias', 'label' => 'Trab 10 - Días', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_horas', 'label' => 'Trab 10 - Horas', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],
    ['key' => 'trab10_ocupacion', 'label' => 'Trab 10 - Ocupación', 'type' => 'text', 'section' => 'P3 Trabajadores 6-10', 'source' => 'payload'],

    // === TOTALES Y FIRMAS P3 ===
    ['key' => 'planilla_total_trabajadores', 'label' => 'Total de Trabajadores', 'type' => 'text', 'section' => 'P3 Totales', 'source' => 'payload'],
    ['key' => 'planilla_total_salarios', 'label' => 'Total de Salarios', 'type' => 'text', 'section' => 'P3 Totales', 'source' => 'payload'],
    ['key' => 'planilla_firma_tomador', 'label' => 'Firma del Tomador del Seguro', 'type' => 'text', 'section' => 'P3 Firmas', 'source' => 'payload'],
    ['key' => 'planilla_representante_nombre', 'label' => 'Nombre Representante (P. Jurídicas)', 'type' => 'text', 'section' => 'P3 Firmas', 'source' => 'payload'],
    ['key' => 'planilla_representante_id', 'label' => 'Identificación Representante', 'type' => 'text', 'section' => 'P3 Firmas', 'source' => 'payload'],
    ['key' => 'planilla_representante_puesto', 'label' => 'Puesto del Representante', 'type' => 'text', 'section' => 'P3 Firmas', 'source' => 'payload'],
];
